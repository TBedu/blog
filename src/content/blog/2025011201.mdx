...
<Error>请一定在 规则 中配置对 login 等表单页面的屏蔽，否则你的网站会被举报！！！</Error>
...
复制 [https://github.com/jonssonyan/cf-workers-proxy/blob/main/_worker.js](https://github.tbedu.top/jonssonyan/cf-workers-proxy/blob/main/_worker.js) 中的所有内容，粘贴到红色方框中，然后点击 `部署`  
